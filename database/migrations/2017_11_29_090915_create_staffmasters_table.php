...
class CreateStaffmastersTable extends Migration
{
	...
	public function up()
	{
		Schema::create('pay_master_staffs', function(Blueprint $table) {
            ...
            $table->string( 'sex');
            $table->string( 'maritial_status')->index();
            $table->date(   'dob');
