...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_0__timeline_timeline_component__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_1__notification_notification_component__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__nav_list_widget_nav_list_widget_component__ = __webpack_require__("./src/app/layout/dashboard/components/nav-list-widget/nav-list-widget.component.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__nav_list_widget_nav_list_widget_component__["a"]; });
...
/***/ "./src/app/layout/dashboard/components/nav-list-widget/nav-list-widget.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"card card-default card-widget\">\r\n    <div class=\"card-header bg-default-white\">\r\n        <i class=\"fa fa-fw\"  [ngClass]=\"widgetIcon\"></i> \r\n        <span>{{ widgetTitle }}</span>\r\n    </div>\r\n    <!-- /.card-header -->\r\n    <div class=\"card-block\">\r\n        <ul class=\"list-group\">\r\n            <li *ngFor=\"let item of widgetItems\" class=\"list-group-item\">\r\n              <a [routerLink]=\"[item.route]\"><i class=\"fa fa-chevron-right fa-fw list-group-icon\" aria-hidden=\"true\"></i> {{ item.name }}</a>\r\n            </li>\r\n        </ul>\r\n    </div>\r\n    <!-- /.card-body -->\r\n</div>\r\n<!-- /.card -->\r\n"

/***/ }),

/***/ "./src/app/layout/dashboard/components/nav-list-widget/nav-list-widget.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/layout/dashboard/components/nav-list-widget/nav-list-widget.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NavListWidgetComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var NavListWidgetComponent = /** @class */ (function () {
    function NavListWidgetComponent() {
    }
    NavListWidgetComponent.prototype.ngOnInit = function () {
        this.widgetItems = this.ListData;
        this.widgetTitle = this.ListTitle;
        this.widgetIcon = this.ListIcon;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('ListData'),
        __metadata("design:type", Object)
    ], NavListWidgetComponent.prototype, "ListData", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", String)
    ], NavListWidgetComponent.prototype, "ListTitle", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('ListIcon'),
        __metadata("design:type", Object)
    ], NavListWidgetComponent.prototype, "ListIcon", void 0);
    NavListWidgetComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-nav-list-widget',
            template: __webpack_require__("./src/app/layout/dashboard/components/nav-list-widget/nav-list-widget.component.html"),
            styles: [__webpack_require__("./src/app/layout/dashboard/components/nav-list-widget/nav-list-widget.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], NavListWidgetComponent);
    return NavListWidgetComponent;
}());

//# sourceMappingURL=nav-list-widget.component.js.map
...
module.exports = "<div [@routerTransition] style=\"padding: 5px;\">\r\n    <div class=\"row\">\r\n        <div class=\"col-md-3\">\r\n            <app-nav-list-widget [ListTitle]=\"transaction['title']\" [ListIcon]=\"transaction['icon']\" [ListData]=\"transaction['items']\"></app-nav-list-widget>\r\n        </div>\r\n        <div class=\"col-md-3\">\r\n            <app-nav-list-widget [ListTitle]=\"reports['title']\" [ListIcon]=\"reports['icon']\" [ListData]=\"reports['items']\"></app-nav-list-widget>\r\n        </div>\r\n        <div class=\"col-md-3\">\r\n            <app-nav-list-widget [ListTitle]=\"masters['title']\" [ListIcon]=\"masters['icon']\" [ListData]=\"masters['items']\"></app-nav-list-widget>\r\n            <app-nav-list-widget [ListTitle]=\"utility['title']\" [ListIcon]=\"utility['icon']\" [ListData]=\"utility['items']\"></app-nav-list-widget>\r\n        </div>\r\n        <div class=\"col-md-3\">\r\n            <app-nav-list-widget [ListTitle]=\"setup['title']\" [ListIcon]=\"setup['icon']\" [ListData]=\"setup['items']\"></app-nav-list-widget>\r\n        </div>\r\n    </div>\r\n</div>"
            ...
            items: [
                {
                    ...
                    route: '/inventory/product-category-master'
                },
                {
                    name: 'Chart Of Items',
                ...
                {
                    name: 'Unit Master',
                    route: '/inventory/unit-master'
                },
                {
                    name: 'Bill Of Material',
                    route: '/inventory/bill-of-material'
                },
                {
                    name: 'Bill Sundry',
                    route: '/accounting/bill-sundry-master'
                },
            ]
        };
        this.transaction = {
            ...
            items: [
                {
                    name: 'Store Items (Stock)',
                    route: '/inventory/store-transaction'
                },
                {
                    name: 'Requisition/Indents',
                    route: '/inventory/requisition-detail-master'
                },
                {
                    name: 'Import Good Receipt Note',
                    route: '/inventory/te-direct-grn'
                },
                {
                ...
                {
                    name: 'Direct DRN',
                    route: '/inventory/direct-grn'
                },
                {
                    name: 'Purchase Order(Req)',
                    route: '/inventory/po-requisition-detail-master'
                },
                {
                    name: 'Material Issue',
                ...
                },
                {
                    ...
                    route: '/inventory/production-voucher'
                },
                {
                    name: 'Stock Journal',
                    route: '/inventory/stock-journal'
                },
                {
                    name: 'Sales',
                ...
                {
                    name: 'Store Transfer',
                    route: '/inventory/store-transfer'
                },
                {
            ...
            items: [
                {
                    ...
                    route: '/reports/cost-of-materials'
                },
                {
                    name: 'Stock Report',
                    route: '/reports/store-ledger-report'
                },
                {
                    name: 'Stock Ledger',
                    route: '/reports/stock-ledger-report'
                },
                {
                    name: 'Opening Report',
                    route: '/reports/opening-report'
                },
                {
                    name: 'Current Fifo Report',
                    route: '/reports/closing-fifo-report'
                },
                {
                    name: 'Daily Store Log',
                    route: '/reports/daily-store-log-report'
                },
                {
                    name: 'Store Items (Stock)',
                    route: '/inventory/store-transaction'
                },
                {
                    ...
                    route: '/reports/goods-receipt-report'
                },
                {
                    name: 'Material Issue Report',
                    route: '/reports/material-issue-report'
                },
                {
                    name: 'PO (with Requisition)',
                    route: '/reports/po-with-requisition-report'
                },
                {
                    name: 'PO Direct',
                    route: '/reports/po-direct'
                },
            ]
        };
        this.setup = {
            ...
            items: [
                ...
                {
                    name: 'Fiscal Year',
                    route: '/inventory/fiscal-year'
                },
                {
                    name: 'Inventory Setup',
                    route: '/inventory/inventory-setup'
                },
                {
                    name: 'Store Master',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components__ = __webpack_require__("./src/app/layout/dashboard/components/index.ts");
    ...
    DashboardModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__shared__["_11" /* StatModule */],
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__dashboard_component__["a" /* DashboardComponent */],
                __WEBPACK_IMPORTED_MODULE_4__components__["d" /* TimelineComponent */],
                __WEBPACK_IMPORTED_MODULE_4__components__["c" /* NotificationComponent */],
                __WEBPACK_IMPORTED_MODULE_4__components__["a" /* ChatComponent */],
                __WEBPACK_IMPORTED_MODULE_4__components__["b" /* NavListWidgetComponent */]
            ]
        })
    ], DashboardModule);
