...
/***/ "./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-add/receipt-voucher-form-add.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReceiptVoucherFormAddComponent; });
...
var ReceiptVoucherFormAddComponent = /** @class */ (function () {
    function ReceiptVoucherFormAddComponent(fb, apiUrl, jvfs, ehs, cdr, ahs, ats, cus) {
        var _this = this;
        this.fb = fb;
        this.jvfs = jvfs;
        this.ehs = ehs;
        ...
        this.columns = [
            ...
            {
                text: 'Cr Amount', datafield: 'value', columntype: 'textbox', width: 100,
                aggregates: [{
    ...
    ReceiptVoucherFormAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.accHeadItemAdapter = new jqx.dataAdapter(this.accHeadItemSource, {
            downloadComplete: function (data, status, xhr) {
                ...
                //   tData[i]['group_code'] = tData[i]['group_code'] + ' - ' + tData[i]['name'];
                // }
        ...
        this.costCenterSource =
            {
                ...
                data: this.userData,
                async: false,
                url: this.apiUrl + 'costcenter?limit=all&transact=1'
            };
    ...
    ReceiptVoucherFormAddComponent.prototype.ngAfterViewInit = function () {
        this.datetime.value(new Date());
        this.cdr.detectChanges();
    };
    ReceiptVoucherFormAddComponent.prototype.createForm = function () {
    ...
    ReceiptVoucherFormAddComponent.prototype.addNewItem = function () {
        var datarow = this.generaterow();
        this.jvfAddGrid.addrow(null, datarow);
    };
    ReceiptVoucherFormAddComponent.prototype.generaterow = function () {
        var row = {};
        row['account_head_id'] = '';
        row['cost_center_id'] = '';
        row['value'] = '';
    ...
    ReceiptVoucherFormAddComponent.prototype.saveBtn = function (post) {
        var _this = this;
    ...
    ReceiptVoucherFormAddComponent.prototype.cancelBtn = function () {
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "jvfAddGrid", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "myComboBox", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "myComboBox2", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "datetime", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "accountHeadCombo", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "winNotification", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "jqxLoader", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormAddComponent.prototype, "myValidator", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], ReceiptVoucherFormAddComponent.prototype, "AddedData", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], ReceiptVoucherFormAddComponent.prototype, "cancelData", void 0);
    ReceiptVoucherFormAddComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-receipt-voucher-form-add',
            template: __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-add/receipt-voucher-form-add.component.html"),
            styles: [__webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-add/receipt-voucher-form-add.component.scss")]
        }),
    ...
    ], ReceiptVoucherFormAddComponent);
    return ReceiptVoucherFormAddComponent;
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
}());

//# sourceMappingURL=receipt-voucher-form-add.component.js.map

/***/ }),

/***/ "./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-edit/receipt-voucher-form-edit.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-edit/receipt-voucher-form-edit.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-edit/receipt-voucher-form-edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReceiptVoucherFormEditComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/@angular/forms.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared__ = __webpack_require__("./src/app/shared/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jqwidgets_framework_jqwidgets_ts_angular_jqxvalidator__ = __webpack_require__("./node_modules/jqwidgets-framework/jqwidgets-ts/angular_jqxvalidator.ts");
...
var ReceiptVoucherFormEditComponent = /** @class */ (function () {
    function ReceiptVoucherFormEditComponent(fb, apiUrl, ehs, jvfs, cdr, ahs, ats, cus) {
        var _this = this;
        this.fb = fb;
        this.ehs = ehs;
        this.jvfs = jvfs;
        ...
        this.source = {
            ...
            datafields: [
                ...
                { name: 'value', type: 'string', map: 'value>cr_value' },
                { name: 'remarks', type: 'string' },
                { name: 'particulars', type: 'string' },
                { name: 'cheque_no', type: 'string' },
                { name: 'bank_name', type: 'string' },
    ...
    ReceiptVoucherFormEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ahs.index({}).subscribe(function (res) {
            _this.accHeadAdapter = res;
        }, function (error) {
    ...
    ReceiptVoucherFormEditComponent.prototype.ngAfterViewInit = function () {
        this.source.localdata = this.JVFEditData['account_transaction_splits'];
        this.jvfEditGrid.updatebounddata("cells");
        this.cdr.detectChanges();
    };
    ReceiptVoucherFormEditComponent.prototype.createForm = function () {
        this.jvfForm = this.fb.group({
            'date': [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required],
            'vouchar_no': [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required],
        });
    };
    ReceiptVoucherFormEditComponent.prototype.addNewItem = function () {
        var datarow = this.generaterow();
        this.jvfEditGrid.addrow(null, datarow);
    };
    ReceiptVoucherFormEditComponent.prototype.generaterow = function () {
        var row = {};
        row['account_head_id'] = '';
        row['cost_center_id'] = '';
        row['value'] = '';
    ...
    ReceiptVoucherFormEditComponent.prototype.saveBtn = function (post) {
        var _this = this;
        ...
        post['accountTransactionSplits'] = jvfgridData;
        post['dr_account_head'] = this.accountHeadCombo.val();
        post['vouchar_type'] = 'RV';
        this.myValidator.validate(document.getElementById('jvfForm'));
        if (post['accountTransactionSplits'].length > 0) {
            this.jqxLoader.open();
    ...
    ReceiptVoucherFormEditComponent.prototype.cancelBtn = function () {
        this.cancelData.emit(true);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('jvfEditGrid'),
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4_jqwidgets_framework_jqwidgets_ts_angular_jqxgrid__["a" /* jqxGridComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_jqwidgets_framework_jqwidgets_ts_angular_jqxgrid__["a" /* jqxGridComponent */]) === "function" && _a || Object)
    ], ReceiptVoucherFormEditComponent.prototype, "jvfEditGrid", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('myComboBox'),
        __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_6_jqwidgets_framework_jqwidgets_ts_angular_jqxcombobox__["a" /* jqxComboBoxComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_jqwidgets_framework_jqwidgets_ts_angular_jqxcombobox__["a" /* jqxComboBoxComponent */]) === "function" && _b || Object)
    ], ReceiptVoucherFormEditComponent.prototype, "myComboBox", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('myComboBox2'),
        __metadata("design:type", typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6_jqwidgets_framework_jqwidgets_ts_angular_jqxcombobox__["a" /* jqxComboBoxComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_jqwidgets_framework_jqwidgets_ts_angular_jqxcombobox__["a" /* jqxComboBoxComponent */]) === "function" && _c || Object)
    ], ReceiptVoucherFormEditComponent.prototype, "myComboBox2", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('accountHeadCombo'),
    ...
    ], ReceiptVoucherFormEditComponent.prototype, "accountHeadCombo", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('datetime'),
    ...
    ], ReceiptVoucherFormEditComponent.prototype, "datetime", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('winNotification'),
        __metadata("design:type", typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_8_jqwidgets_framework_jqwidgets_ts_angular_jqxnotification__["a" /* jqxNotificationComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8_jqwidgets_framework_jqwidgets_ts_angular_jqxnotification__["a" /* jqxNotificationComponent */]) === "function" && _f || Object)
    ], ReceiptVoucherFormEditComponent.prototype, "winNotification", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('jqxLoader'),
        __metadata("design:type", typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_5_jqwidgets_framework_jqwidgets_ts_angular_jqxloader__["a" /* jqxLoaderComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5_jqwidgets_framework_jqwidgets_ts_angular_jqxloader__["a" /* jqxLoaderComponent */]) === "function" && _g || Object)
    ], ReceiptVoucherFormEditComponent.prototype, "jqxLoader", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('myValidator'),
        __metadata("design:type", typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_3_jqwidgets_framework_jqwidgets_ts_angular_jqxvalidator__["a" /* jqxValidatorComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_jqwidgets_framework_jqwidgets_ts_angular_jqxvalidator__["a" /* jqxValidatorComponent */]) === "function" && _h || Object)
    ], ReceiptVoucherFormEditComponent.prototype, "myValidator", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('JVFEditData'),
        __metadata("design:type", Object)
    ], ReceiptVoucherFormEditComponent.prototype, "JVFEditData", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], ReceiptVoucherFormEditComponent.prototype, "UpdatedData", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], ReceiptVoucherFormEditComponent.prototype, "cancelData", void 0);
    ReceiptVoucherFormEditComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-receipt-voucher-form-edit',
            template: __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-edit/receipt-voucher-form-edit.component.html"),
            styles: [__webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-edit/receipt-voucher-form-edit.component.scss")]
        }),
        __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Inject"])('API_URL')),
    ...
    ], ReceiptVoucherFormEditComponent);
    return ReceiptVoucherFormEditComponent;
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
}());

//# sourceMappingURL=receipt-voucher-form-edit.component.js.map

/***/ }),

/***/ "./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReceiptVoucherFormRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__receipt_voucher_form_component__ = __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReceiptVoucherFormComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/@angular/forms.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__receipt_voucher_form_add_receipt_voucher_form_add_component__ = __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-add/receipt-voucher-form-add.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReceiptVoucherFormComponent = /** @class */ (function () {
    function ReceiptVoucherFormComponent(jvfs, componentFactoryResolver, apiUrl, fileExport, ats, fb, cus) {
        var _this = this;
        this.jvfs = jvfs;
        ...
        this.rendertoolbar = function (toolbar) {
            ...
            addRowButton.addEventHandler('click', function () {
                ...
                _this.myWindow.title('Add Receipt Voucher Form');
                _this.myWindow.open();
                var componentFactory = _this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_7__receipt_voucher_form_add_receipt_voucher_form_add_component__["a" /* ReceiptVoucherFormAddComponent */]);
                _this.Insert.clear();
    ...
    ReceiptVoucherFormComponent.prototype.ngOnInit = function () {
        this.createQuickAccess();
    };
    ReceiptVoucherFormComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    ReceiptVoucherFormComponent.prototype.createForm = function () {
    ...
    ReceiptVoucherFormComponent.prototype.createQuickAccess = function () {
    ...
    ReceiptVoucherFormComponent.prototype.getJVForm = function () {
        var _this = this;
        var myUrl = this.apiUrl + 'account_transaction?vouchar_type=RV&required=VOUCHAR_FORM';
        this.source =
            {
                datatype: 'json',
                datafields: [
                    { name: 'id', type: 'number' },
                    { name: 'enter_date', type: 'date' },
        ...
        this.columns =
            [
                ...
                //     this.myWindow.open();
                //     const componentFactory = this.componentFactoryResolver.resolveComponentFactory(ReceiptVoucherFormEditComponent);
                //     this.Insert.clear();
                //     const dynamic_Component = this.Insert.createComponent(componentFactory);
                //     (<ReceiptVoucherFormEditComponent>dynamic_Component.instance).JVFEditData = dataRecord;
                //     (<ReceiptVoucherFormEditComponent>dynamic_Component.instance).UpdatedData.subscribe(result => {
                //       if (result.result == true) {
                ...
                //       }
                //     });
                //     (<ReceiptVoucherFormEditComponent>dynamic_Component.instance).cancelData.subscribe(result => {
                //       if (result == true) {
                //         this.myWindow.hide();
                //         dynamic_Component.destroy();
                //       }
                ...
                // },
                {
                    ...
                    buttonclick: function (row) {
                        ...
                        _this.myDetailWindow.title('Receipt Detail');
                        _this.myDetailWindow.open();
                    }
                }
            ];
    };
    ReceiptVoucherFormComponent.prototype.rowChange = function (event) {
        var dataRecord = this.myGrid.getrowdata(event.args.rowindex);
        if (dataRecord) {
            this.selectedOrderList.push(dataRecord['id']);
        }
    };
    ReceiptVoucherFormComponent.prototype.rowUnChange = function (event) {
        var dataRecord = this.myGrid.getrowdata(event.args.rowindex);
        if (dataRecord) {
    ...
    ReceiptVoucherFormComponent.prototype.approve = function (formData) {
        var _this = this;
        this.jqxLoader.open();
    ...
    ], ReceiptVoucherFormComponent.prototype, "winNotification", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormComponent.prototype, "msgNotification", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormComponent.prototype, "errNotification", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormComponent.prototype, "myGrid", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('jqxLoader'),
    ...
    ], ReceiptVoucherFormComponent.prototype, "jqxLoader", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormComponent.prototype, "myWindow", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormComponent.prototype, "myDetailWindow", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormComponent.prototype, "Insert", void 0);
    __decorate([
    ...
    ], ReceiptVoucherFormComponent.prototype, "quickAccess", void 0);
    ReceiptVoucherFormComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-receipt-voucher-form',
            template: __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form.component.html"),
            styles: [__webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form.component.scss")]
        }),
    ...
    return ReceiptVoucherFormComponent;
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q;
}());

//# sourceMappingURL=receipt-voucher-form.component.js.map

/***/ }),

/***/ "./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReceiptVoucherFormModule", function() { return ReceiptVoucherFormModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__receipt_voucher_form_routing_module__ = __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__receipt_voucher_form_component__ = __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__receipt_voucher_form_add_receipt_voucher_form_add_component__ = __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-add/receipt-voucher-form-add.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__receipt_voucher_form_edit_receipt_voucher_form_edit_component__ = __webpack_require__("./src/app/layout/accounting/receipt-voucher-form/receipt-voucher-form-edit/receipt-voucher-form-edit.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReceiptVoucherFormModule = /** @class */ (function () {
    function ReceiptVoucherFormModule() {
    }
    ReceiptVoucherFormModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */],
                __WEBPACK_IMPORTED_MODULE_2__shared_modules_shared_module__["a" /* SharedModule */],
                __WEBPACK_IMPORTED_MODULE_3__receipt_voucher_form_routing_module__["a" /* ReceiptVoucherFormRoutingModule */]
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_5__receipt_voucher_form_add_receipt_voucher_form_add_component__["a" /* ReceiptVoucherFormAddComponent */],
                __WEBPACK_IMPORTED_MODULE_6__receipt_voucher_form_edit_receipt_voucher_form_edit_component__["a" /* ReceiptVoucherFormEditComponent */],
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__receipt_voucher_form_component__["a" /* ReceiptVoucherFormComponent */],
                __WEBPACK_IMPORTED_MODULE_5__receipt_voucher_form_add_receipt_voucher_form_add_component__["a" /* ReceiptVoucherFormAddComponent */],
                __WEBPACK_IMPORTED_MODULE_6__receipt_voucher_form_edit_receipt_voucher_form_edit_component__["a" /* ReceiptVoucherFormEditComponent */],
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], ReceiptVoucherFormModule);
    return ReceiptVoucherFormModule;
}());

//# sourceMappingURL=receipt-voucher-form.module.js.map

/***/ })

});
//# sourceMappingURL=receipt-voucher-form.module.chunk.js.map